import { PageHeader, MyProductStatus } from '@/components';
...
const SellerHomePage = () => {
  return (
    <section className="bg-grey01 scrollbar-hide relative flex w-full flex-1 flex-col gap-7 overflow-y-auto">
      <PageHeader
